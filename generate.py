...
formats = [
    ...
    ("YCCK", "JPEG", "RGB", f"convert $1 -colorspace CMYK $2.jpg && exiftool \"-icc_profile<=CMYK/USWebCoatedSWOP.icc\" $2.jpg && rm $2.jpg_original"),
    ("CMYK", "JPEG", "CMYK", "cp $1 $2.jpg && exiftool \"-icc_profile<=CMYK/USWebCoatedSWOP.icc\" $2.jpg && rm $2.jpg_original", "jpg"),
